...
print "This script calculates the population change between a pair of years for all cities."
...
# aren't found in the dict, it asks the user to try again
    user_input_year1 = raw_input("Please enter the first year (between 1970-2010, 5 year increments) > ")
